...
export declare class NestableComponent implements OnInit, OnDestroy {
    ...
    expandAll(): void;
    collapseAll(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<NestableComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<NestableComponent, "ngx-nestable", never, { "options": "options"; "disableDrag": "disableDrag"; "list": "list"; "template": "template"; }, { "listChange": "listChange"; "drop": "drop"; "drag": "drag"; "disclosure": "disclosure"; }, never, never, false, never>;
}

//# sourceMappingURL=nestable.component.d.ts.map
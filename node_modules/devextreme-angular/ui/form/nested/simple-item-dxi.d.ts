...
export declare class DxiFormSimpleItemComponent extends CollectionNestedOption implements AfterViewInit, IDxTemplateHost, AfterContentInit {
    private renderer;
    private document;
    private element;
    ...
    asyncRulesChildren: QueryList<DxiFormAsyncRuleComponent>;
    compareRulesChildren: QueryList<DxiFormCompareRuleComponent>;
    customRulesChildren: QueryList<DxiFormCustomRuleComponent>;
    emailRulesChildren: QueryList<DxiFormEmailRuleComponent>;
    numericRulesChildren: QueryList<DxiFormNumericRuleComponent>;
    patternRulesChildren: QueryList<DxiFormPatternRuleComponent>;
    rangeRulesChildren: QueryList<DxiFormRangeRuleComponent>;
    requiredRulesChildren: QueryList<DxiFormRequiredRuleComponent>;
    stringLengthRulesChildren: QueryList<DxiFormStringLengthRuleComponent>;
    validationRulesChildren: QueryList<DxiFormValidationRuleComponent>;

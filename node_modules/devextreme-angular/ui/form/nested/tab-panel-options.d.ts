...
export declare class DxoFormTabPanelOptionsComponent extends NestedOption implements OnDestroy, OnInit, AfterContentInit {
    ...
    tabPanelOptionsItemsChildren: QueryList<DxiFormTabPanelOptionsItemComponent>;
    setItems(): void;

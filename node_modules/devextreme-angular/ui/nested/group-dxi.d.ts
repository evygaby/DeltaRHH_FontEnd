...
export declare class DxiGroupComponent extends CollectionNestedOption {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxiGroupComponent, "dxi-group", never, { "commands": { "alias": "commands"; "required": false; }; "title": { "alias": "title"; "required": false; }; "category": { "alias": "category"; "required": false; }; "displayMode": { "alias": "displayMode"; "required": false; }; "expanded": { "alias": "expanded"; "required": false; }; "shapes": { "alias": "shapes"; "required": false; }; }, {}, ["commandsChildren"], never, true, never>;
}

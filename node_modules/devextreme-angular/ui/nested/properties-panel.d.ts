...
export declare class DxoPropertiesPanelComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoPropertiesPanelComponent, "dxo-properties-panel", never, { "tabs": { "alias": "tabs"; "required": false; }; "visibility": { "alias": "visibility"; "required": false; }; }, {}, ["tabsChildren"], never, true, never>;
}

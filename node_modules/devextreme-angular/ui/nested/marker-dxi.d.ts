...
export declare class DxiMarkerComponent extends CollectionNestedOption {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxiMarkerComponent, "dxi-marker", never, { "iconSrc": { "alias": "iconSrc"; "required": false; }; "location": { "alias": "location"; "required": false; }; "onClick": { "alias": "onClick"; "required": false; }; "tooltip": { "alias": "tooltip"; "required": false; }; }, {}, ["locationChildren"], never, true, never>;
}

...
export declare class DxoDiagramToolboxComponent extends NestedOption implements OnDestroy, OnInit, AfterContentInit {
    get groups(): {
    ...
    toolboxGroupsChildren: QueryList<DxiDiagramToolboxGroupComponent>;
    setGroups(): void;

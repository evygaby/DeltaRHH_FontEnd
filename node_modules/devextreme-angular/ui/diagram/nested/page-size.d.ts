...
export declare class DxoDiagramPageSizeComponent extends NestedOption implements OnDestroy, OnInit, AfterContentInit {
    get height(): number;
    ...
    itemsChildren: QueryList<DxiDiagramItemComponent>;
    pageSizeItemsChildren: QueryList<DxiDiagramPageSizeItemComponent>;
    setItems(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoDiagramPageSizeComponent, "dxo-diagram-page-size", never, { "height": { "alias": "height"; "required": false; }; "items": { "alias": "items"; "required": false; }; "width": { "alias": "width"; "required": false; }; }, { "heightChange": "heightChange"; "widthChange": "widthChange"; }, ["itemsChildren", "pageSizeItemsChildren"], never, true, never>;
}

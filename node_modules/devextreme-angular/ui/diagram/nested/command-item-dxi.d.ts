...
export declare class DxiDiagramCommandItemComponent extends CollectionNestedOption implements AfterContentInit {
    get icon(): string;
    ...
    commandItemsChildren: QueryList<DxiDiagramCommandItemComponent>;

...
export declare class DxiDiagramTabGroupComponent extends CollectionNestedOption {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxiDiagramTabGroupComponent, "dxi-diagram-tab-group", never, { "commands": { "alias": "commands"; "required": false; }; "title": { "alias": "title"; "required": false; }; }, {}, ["commandsChildren"], never, true, never>;
}

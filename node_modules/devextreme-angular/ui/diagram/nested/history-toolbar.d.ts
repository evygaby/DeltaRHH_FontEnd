...
export declare class DxoDiagramHistoryToolbarComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoDiagramHistoryToolbarComponent, "dxo-diagram-history-toolbar", never, { "commands": { "alias": "commands"; "required": false; }; "visible": { "alias": "visible"; "required": false; }; }, {}, ["commandsChildren"], never, true, never>;
}

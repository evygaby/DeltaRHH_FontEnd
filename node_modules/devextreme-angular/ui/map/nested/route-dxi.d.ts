...
export declare class DxiMapRouteComponent extends CollectionNestedOption {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxiMapRouteComponent, "dxi-map-route", never, { "color": { "alias": "color"; "required": false; }; "locations": { "alias": "locations"; "required": false; }; "mode": { "alias": "mode"; "required": false; }; "opacity": { "alias": "opacity"; "required": false; }; "weight": { "alias": "weight"; "required": false; }; }, {}, ["locationsChildren"], never, true, never>;
}

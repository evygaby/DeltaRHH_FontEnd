...
export declare class DxiTreeListColumnComponent extends CollectionNestedOption implements AfterContentInit {
    ...
    asyncRulesChildren: QueryList<DxiTreeListAsyncRuleComponent>;
    compareRulesChildren: QueryList<DxiTreeListCompareRuleComponent>;
    customRulesChildren: QueryList<DxiTreeListCustomRuleComponent>;
    emailRulesChildren: QueryList<DxiTreeListEmailRuleComponent>;
    numericRulesChildren: QueryList<DxiTreeListNumericRuleComponent>;
    patternRulesChildren: QueryList<DxiTreeListPatternRuleComponent>;
    rangeRulesChildren: QueryList<DxiTreeListRangeRuleComponent>;
    requiredRulesChildren: QueryList<DxiTreeListRequiredRuleComponent>;
    stringLengthRulesChildren: QueryList<DxiTreeListStringLengthRuleComponent>;
    validationRulesChildren: QueryList<DxiTreeListValidationRuleComponent>;

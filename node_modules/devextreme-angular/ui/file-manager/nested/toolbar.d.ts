...
export declare class DxoFileManagerToolbarComponent extends NestedOption implements OnDestroy, OnInit, AfterContentInit {
    ...
    itemsChildren: QueryList<DxiFileManagerItemComponent>;
    toolbarItemsChildren: QueryList<DxiFileManagerToolbarItemComponent>;
    setItems(): void;
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoFileManagerToolbarComponent, "dxo-file-manager-toolbar", never, { "fileSelectionItems": { "alias": "fileSelectionItems"; "required": false; }; "items": { "alias": "items"; "required": false; }; }, {}, ["itemsChildren", "toolbarItemsChildren", "fileSelectionItemsChildren"], never, true, never>;
}

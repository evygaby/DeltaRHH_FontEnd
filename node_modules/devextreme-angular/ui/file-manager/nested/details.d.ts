...
export declare class DxoFileManagerDetailsComponent extends NestedOption implements OnDestroy, OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<DxoFileManagerDetailsComponent, "dxo-file-manager-details", never, { "columns": { "alias": "columns"; "required": false; }; }, {}, ["columnsChildren"], never, true, never>;
}

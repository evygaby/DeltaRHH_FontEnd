...
export declare class DxiDataGridColumnComponent extends CollectionNestedOption implements AfterContentInit {
    ...
    asyncRulesChildren: QueryList<DxiDataGridAsyncRuleComponent>;
    compareRulesChildren: QueryList<DxiDataGridCompareRuleComponent>;
    customRulesChildren: QueryList<DxiDataGridCustomRuleComponent>;
    emailRulesChildren: QueryList<DxiDataGridEmailRuleComponent>;
    numericRulesChildren: QueryList<DxiDataGridNumericRuleComponent>;
    patternRulesChildren: QueryList<DxiDataGridPatternRuleComponent>;
    rangeRulesChildren: QueryList<DxiDataGridRangeRuleComponent>;
    requiredRulesChildren: QueryList<DxiDataGridRequiredRuleComponent>;
    stringLengthRulesChildren: QueryList<DxiDataGridStringLengthRuleComponent>;
    validationRulesChildren: QueryList<DxiDataGridValidationRuleComponent>;

...
export declare class DxoCardViewTabPanelOptionsComponent extends NestedOption implements OnDestroy, OnInit, AfterContentInit {
    ...
    tabPanelOptionsItemsChildren: QueryList<DxiCardViewTabPanelOptionsItemComponent>;
    setItems(): void;

...
import { DxiAlertComponent, DxiItemComponent, DxiTypingUserComponent, DxiAlertModule, DxoDayHeaderFormatModule, DxoEditingModule, DxiItemModule, DxoAuthorModule, DxoMessageTimestampFormatModule, DxiTypingUserModule, DxoUserModule } from 'devextreme-angular/ui/nested';
import { DxiChatAlertComponent, DxiChatItemComponent, DxiChatTypingUserComponent, DxiChatAlertModule, DxoChatAuthorModule, DxoChatDayHeaderFormatModule, DxoChatEditingModule, DxiChatItemModule, DxoChatMessageTimestampFormatModule, DxiChatTypingUserModule, DxoChatUserModule } from 'devextreme-angular/ui/chat/nested';

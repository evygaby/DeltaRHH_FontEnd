    ...
    _triggerOnFieldDataChangedByDataSet: function(data) {
        ...
        if (data && (0, _type.isObject)(data)) {
            Object.keys(data).forEach((function(key) {
                _this9._triggerOnFieldDataChanged({
                    dataField: key,
                    value: data[key]
                })
            }))
                ...
                if ((0, _type.isObject)(option)) {
                    if (!this._tryChangeLayoutManagerItemOptions(path, option)) {
                        ...
                        (0, _iterator.each)(option, (function(optionName, optionValue) {
                            var itemAction = _this10._tryCreateItemOptionAction(optionName, item, optionValue, item[optionName], path);
                            _this10._changeItemOption(item, optionName, optionValue);
                            if (!allowUpdateItems && !_this10._tryExecuteItemOptionAction(itemAction)) {

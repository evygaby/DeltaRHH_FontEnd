...
var DropDownEditor = _text_box.default.inherit({
    ...
    _getAriaHasPopup: function() {
        return "true"
    },
    _getAriaAutocomplete: function() {
        return "list"
    },
    _getAriaRole: function() {
        return "combobox"
    },
    ...
    _renderTemplateWrapper: function() {
        var fieldTemplate = this._getFieldTemplate();
        if (!fieldTemplate) {
            return
        }
    ...
    _integrateInput: function() {
        ...
        null === (_this$option2 = this.option("_onMarkupRendered")) || void 0 === _this$option2 ? void 0 : _this$option2()
    },

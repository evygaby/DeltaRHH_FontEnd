...
var TextEditorBase = _editor.default.inherit({
    ...
    _setFieldAria: function(force) {
        ...
        var labelId = null === (_this$_label = this._label) || void 0 === _this$_label ? void 0 : _this$_label.getId();
    ...
    _renderLabel: function() {
        ...
        var _this$option2 = this.option(),
            label = _this$option2.label,
            labelMode = _this$option2.labelMode,
            labelMark = _this$option2.labelMark;
        var labelConfig = {
            $editor: this.$element(),
            text: label,
            mark: labelMark,

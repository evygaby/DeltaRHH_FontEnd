...
var GanttView = function(_Widget) {
    ...
    _proto._initMarkup = function() {
        ...
        if (visualState) {
            this._restoreStateFrameId = (0, _frame.requestAnimationFrame)((function() {
                return _this._restoreVisualState(visualState)
            }))
        }
    };
    ...
    _proto.getVisualStateToRestore = function() {
        ...
        return _defineProperty({}, fullScreenModeKey, null === (_this$_ganttViewCore4 = this._ganttViewCore) || void 0 === _this$_ganttViewCore4 ? void 0 : _this$_ganttViewCore4.isInFullScreenMode())
    };

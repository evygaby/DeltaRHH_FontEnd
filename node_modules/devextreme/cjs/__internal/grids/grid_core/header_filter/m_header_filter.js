...
var HeaderFilterController = function(_Modules$ViewControll) {
            ...
            (0, _extend.extend)(options, column, {
                ...
                onShowing: function(e) {
                    ...
                    dxResizableInstance && dxResizableInstance.option("onResizeEnd", (function(e) {
                        var headerFilterByColumn = _this._columnsController.columnOption(options.dataField, "headerFilter");
                        headerFilterByColumn = headerFilterByColumn || {};
                        headerFilterByColumn.width = e.width;
                        headerFilterByColumn.height = e.height;
                        _this._columnsController.columnOption(options.dataField, "headerFilter", headerFilterByColumn, true)
                    }))
                },
                onHidden: function() {
...
var columnHeadersView = function(Base) {
    return function(_headerFilterMixin) {
        ...
        _proto2._subscribeToIndicatorEvent = function($indicator, column, indicatorName) {
            ...
            if ("headerFilter" === indicatorName) {
                _events_engine.default.on($indicator, _click.name, this.createAction((function(e) {
                    ...
                    _this2._headerFilterController.showHeaderFilterMenu(column.index, false)
                })))
            }
        };
        _proto2._updateIndicator = function($cell, column, indicatorName) {
            var $indicator = _headerFilterMixin.prototype._updateIndicator.call(this, $cell, column, indicatorName);
...
var headerPanel = function(Base) {
    return function(_headerFilterMixin2) {
        ...
        _proto3._createGroupPanelItem = function($rootElement, groupColumn) {
            var _this3 = this;
            var that = this;
            var $item = _headerFilterMixin2.prototype._createGroupPanelItem.apply(that, arguments);
            var $headerFilterIndicator;
            if (!groupColumn.command && (0, _m_header_filter_core.allowHeaderFiltering)(groupColumn) && that.option("headerFilter.visible")) {
                ...
                $headerFilterIndicator && _events_engine.default.on($headerFilterIndicator, _click.name, that.createAction((function(e) {
                    ...
                    _this3._headerFilterController.showHeaderFilterMenu(groupColumn.index, true)
                })))
            }
            return $item
        };
...
var data = function(Base) {
    return function(_Base) {
        ...
        _proto4._calculateAdditionalFilter = function() {
            ...
            var filters = [_Base.prototype._calculateAdditionalFilter.call(this)];

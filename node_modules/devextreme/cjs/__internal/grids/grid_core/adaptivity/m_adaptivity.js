...
var AdaptiveColumnsController = function(_modules$ViewControll) {
    ...
    _proto.init = function() {
        ...
        this._columnsController.columnsChanged.add((function() {
            var isAdaptiveVisible = !!_this.updateHidingQueue(_this._columnsController.getColumns()).length;
            _this._columnsController.columnOption("command:adaptive", "adaptiveHidden", !isAdaptiveVisible, true)
        }));
        ...
        if (this._isVisibleColumnsValid(visibleColumns) && hiddenQueue.length) {
            ...
            var getVisibleContentColumns = function() {
                ...
                return visibleColumns.filter((function(item) {
                    return !item.command && 0 === _this2._hiddenColumns.filter((function(i) {
    ...
    return function(_Base6) {
        ...
        _proto7._afterSaveEditData = function() {
            ...
            if (this._isRowEditMode() && this._adaptiveColumnsController.hasHiddenColumns()) {
                (0, _deferred.when)(this._validatingController.validate(true)).done((function(isValid) {
                    if (isValid) {
                        _this3._cancelEditAdaptiveDetailRow()
                    }
                    deferred.resolve()
                }))
            } else {

...
var ColumnHeadersView = function(_ColumnsView) {
    ...
    _proto._processTemplate = function(template, options) {
        ...
        var renderingTemplate = _ColumnsView.prototype._processTemplate.call(this, template);
    ...
    _proto._renderCell = function($row, options) {
        var $cell = _ColumnsView.prototype._renderCell.call(this, $row, options);
    ...
    _proto._createCell = function(options) {
        var column = options.column;
        var $cellElement = _ColumnsView.prototype._createCell.apply(this, arguments);
    ...
    _proto._updateIndicator = function($cell, column, indicatorName) {
        var $indicatorElement = _ColumnsView.prototype._updateIndicator.apply(this, arguments);
    ...
    _proto._getIndicatorContainer = function($cell, returnAll) {
        var $indicatorsContainer = _ColumnsView.prototype._getIndicatorContainer.call(this, $cell);

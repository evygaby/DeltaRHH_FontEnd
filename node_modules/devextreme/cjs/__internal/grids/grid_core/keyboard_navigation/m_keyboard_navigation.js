...
var KeyboardNavigationController = function(_modules$ViewControll) {
    ...
    _proto.initDocumentHandlers = function() {
        ...
        this._documentClickHandler = this._documentClickHandler || this.createAction((function(e) {
            ...
            var isColumnResizing = !!_this._columnResizerController && _this._columnResizerController.isResizing();
    ...
    return function(_Base) {
        ...
        _proto2.renderDelayedTemplates = function(change) {
            ...
            this.waitAsyncTemplates().done((function() {
                _this7._renderFocusByChange(change)
            }))
        };
        ...
        _proto2._renderCore = function(change) {
            var deferred = _Base.prototype._renderCore.apply(this, arguments);
...
var editing = function(Base) {
    return function(_Base2) {
        ...
        _proto3.editCell = function(rowIndex, columnIndex) {
            ...
            var isCellEditing = _Base2.prototype.editCell.call(this, rowIndex, columnIndex);
            if (isCellEditing) {
        ...
        _proto3.getFocusedCellInRow = function(rowIndex) {
            var $cell = _Base2.prototype.getFocusedCellInRow.call(this, rowIndex);
            var rowIndexOffset = this._dataController.getRowIndexOffset();
        ...
        _proto3._processCanceledEditingCell = function() {
            ...
            this.closeEditCell().done((function() {
                _this8._keyboardNavigationController._updateFocus()
            }))
        };
        _proto3.closeEditCell = function() {
            var keyboardNavigation = this._keyboardNavigationController;
            keyboardNavigation._fastEditingStarted = false;
            var result = _Base2.prototype.closeEditCell.apply(this, arguments);
        ...
        _proto3._isEditingStart = function() {
            var cancel = _Base2.prototype._isEditingStart.apply(this, arguments);
...
var adaptiveColumns = function(Base) {
    return function(_Base4) {
        ...
        _proto5._showHiddenCellsInView = function(_ref4) {
        ...
        _proto5._hideVisibleCellInView = function(_ref5) {

...
var dataSelectionExtenderMixin = function(Base) {
    return function(_Base) {
        ...
        _proto2._loadDataSource = function() {
            var that = this;
            return _Base.prototype._loadDataSource.call(this).always((function() {
        ...
        _proto2._processDataItem = function(item, options) {
            ...
            var dataItem = _Base.prototype._processDataItem.apply(this, arguments);
        ...
        _proto2.refresh = function(options) {
            ...
            _Base.prototype.refresh.apply(this, arguments).done((function() {
...
var columnHeadersSelectionExtenderMixin = function(Base) {
        ...
        _proto4._renderSelectAllCheckBox = function($container, column) {
            ...
            that._editorFactoryController.createEditor(groupElement, (0, _extend.extend)({}, column, {
                ...
                setValue: function(value, e) {
                    ...
                    if (!e.event || _this4._selectionController.isSelectAll() === value) {
                        return
                    }
                    if (e.value && !allowSelectAll) {
                        e.component.option("value", false)
                    } else {
                        e.value ? _this4._selectionController.selectAll() : _this4._selectionController.deselectAll()
                    }
...
var rowsViewSelectionExtenderMixin = function(Base) {
    return function(_Base4) {
        ...
        _proto5._createTable = function() {
            ...
            var $table = _Base4.prototype._createTable.apply(that, arguments);
        ...
        _proto5._renderCore = function(change) {
            var deferred = _Base4.prototype._renderCore.call(this, change);

...
var FilterPanelView = function(_modules$View) {
    ...
    _proto._getTextElement = function() {
        ...
        if (filterValue) {
            (0, _deferred.when)(that.getFilterText(filterValue, this._filterSyncController.getCustomFilterOperations())).done((function(filterText) {

...
var baseFixedColumns = function(Base) {
    return function(_Base) {
        ...
        _proto._correctColumnIndicesForFixedColumns = function(fixedColumns, change) {
            ...
            var rowTypes = null === (_a = null === change || void 0 === change ? void 0 : change.items) || void 0 === _a ? void 0 : _a.map((function(_ref) {
                var rowType = _ref.rowType;
                return rowType
            }));
            change.columnIndices = columnIndicesArray.map((function(columnIndices, idx) {
                if (!_this.isIndicesArray(columnIndices)) {
                    return columnIndices
                }
                var isGroupRow = rowTypes && "group" === rowTypes[idx];
                if (isGroupRow) {
                    return _toConsumableArray(columnIndices)
                }
                return columnIndices.reduce((function(result, colIdx) {
                    switch (true) {
        ...
        _proto._renderTable = function(options) {
            ...
            var $table = _Base.prototype._renderTable.call(this, options);
        ...
        _proto._createCell = function(options) {
            ...
            var $cell = _Base.prototype._createCell.apply(that, arguments);
            var fixedColumns;
            var prevFixedColumn;
        ...
        _proto._wrapTableInScrollContainer = function($table, isFixedTableRendering) {
            var $scrollContainer = _Base.prototype._wrapTableInScrollContainer.apply(this, arguments);
        ...
        _proto._getCellElementsCore = function(rowIndex) {
            var _this2 = this;
            var cellElements = _Base.prototype._getCellElementsCore.apply(this, arguments);
        ...
        _proto.getColumnWidths = function(fixedTableElement) {
            var result = _Base.prototype.getColumnWidths.call(this);
            var fixedColumns = this.getFixedColumns();
            var fixedWidths = this._fixedTableElement && result.length ? _Base.prototype.getColumnWidths.call(this, this._fixedTableElement) : void 0;
        ...
        _proto.getTableElement = function(isFixedTableRendering) {
            ...
            var tableElement = isFixedTableRendering ? this._fixedTableElement : _Base.prototype.getTableElement.call(this);
            return tableElement
        };
        ...
        _proto.getTableElements = function() {
            var result = _Base.prototype.getTableElements.apply(this, arguments);
...
var columnHeadersView = function(Base) {
    return function(_baseFixedColumns) {
        ...
        _proto2.getContextMenuItems = function(options) {
            ...
            var items = _baseFixedColumns.prototype.getContextMenuItems.call(this, options);
        ...
        _proto2.getColumnWidths = function() {
            var fixedWidths;
            var result = _baseFixedColumns.prototype.getColumnWidths.call(this);
            ...
            if (this._fixedTableElement) {
                if ($fixedColumnElements && $fixedColumnElements.length) {
                    ...
                    fixedWidths = _baseFixedColumns.prototype.getColumnWidths.call(this, this._fixedTableElement)
                }
            }
            return normalizeColumnWidths(fixedColumns, result, fixedWidths)
        };
...
var rowsView = function(Base) {
    return function(_baseFixedColumns2) {
        ...
        _proto3._attachHoverEvents = function() {
            ...
            if (this._fixedTableElement && this._tableElement) {
                _events_engine.default.on(this.element(), "mouseover mouseout", ".dx-data-row", this.createAction((function(args) {
                    ...
                    var rowIndex = _this5.getRowIndex((0, _renderer.default)(event.target).closest(".dx-row"));
                    var isHover = "mouseover" === event.type;
                    if (rowIndex >= 0) {
                        _this5._tableElement && _this5._getRowElements(_this5._tableElement).eq(rowIndex).toggleClass(HOVER_STATE_CLASS, isHover);
                        _this5._fixedTableElement && _this5._getRowElements(_this5._fixedTableElement).eq(rowIndex).toggleClass(HOVER_STATE_CLASS, isHover)
                    }
                })))
            }
        };
            ...
            if (element && isFixedTableRendering) {
                ...
                if (!$content.length && scrollable) {
                    ...
                    _events_engine.default.on($content, "scroll", (function(e) {
                        var target = e.target;
                        var scrollDelay = _this6._getScrollDelay();
                        clearTimeout(_this6._fixedScrollTimeout);
                        _this6._fixedScrollTimeout = setTimeout((function() {
                    ...
                    _events_engine.default.on($content, _wheel.name, (function(e) {
                        ...
                        if (shouldScroll) {
                            ...
                            var scrollableHeight = scrollable.scrollHeight() + _this6.getScrollbarWidth();
        ...
        _proto3._hasAlignByColumnSummaryItems = function(columnIndex, options) {
            var result = _baseFixedColumns2.prototype._hasAlignByColumnSummaryItems.apply(this, arguments);
        ...
        _proto3._renderCore = function(change) {
            ...
            var deferred = _baseFixedColumns2.prototype._renderCore.call(this, change);
...
var footerView = function(Base) {
    return function(_baseFixedColumns3) {
...
var draggingHeader = function(Base) {
    return function(_Base2) {
        ...
        _proto4._generatePointsByColumns = function(options) {
            ...
            if (targetDraggingPanel && "headers" === targetDraggingPanel.getName() && targetDraggingPanel.isFixedColumns()) {
                if (options.sourceColumn.fixed) {
                    ...
                    var pointsByColumns = _Base2.prototype._generatePointsByColumns.call(this, options);
        ...
        _proto4._pointCreated = function(point, columns, location, sourceColumn) {
            var result = _Base2.prototype._pointCreated.apply(this, arguments);

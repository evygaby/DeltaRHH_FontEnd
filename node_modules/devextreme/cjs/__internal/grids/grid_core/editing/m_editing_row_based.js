...
var editingControllerExtender = function(Base) {
    return function(_Base) {
        ...
        _proto._isDefaultButtonVisible = function(button, options) {
            ...
            var isEditRow = !isPopupEditMode && options.row && (0, _common.equalByValue)(options.row.key, this.option(_const.EDITING_EDITROWKEY_OPTION_NAME));
            if (isRowMode) {
                switch (button.name) {
                    case "edit":
...
var rowsView = function(Base) {
    return function(_Base3) {
        ...
        _proto3._createRow = function(row) {
            var $row = _Base3.prototype._createRow.apply(this, arguments);
            if (row) {

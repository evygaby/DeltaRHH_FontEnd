...
var editingControllerExtender = function(Base) {
    return function(_Base) {
        ...
        _proto.renderFormEditorTemplate = function(detailCellOptions, item, formTemplateOptions, container, isReadOnly) {
            ...
            var displayValue = _m_utils.default.getDisplayValue(column, value, rowData, null === row || void 0 === row ? void 0 : row.rowType);
...
var rowsView = function(Base) {
    return function(_Base3) {
        ...
        _proto3.getCellElements = function(rowIndex) {
            var $cellElements = _Base3.prototype.getCellElements.call(this, rowIndex);
        ...
        _proto3._updateContent = function() {
            ...
            var deferred = _Base3.prototype._updateContent.apply(this, arguments);

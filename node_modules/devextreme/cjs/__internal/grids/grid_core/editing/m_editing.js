...
var EditingControllerImpl = function(_modules$ViewControll) {
    ...
    _proto._getDefaultEditorTemplate = function() {
        ...
        return function(container, options) {
            ...
            _this._editorFactoryController.createEditor($editor, editorOptions)
        }
    };
    ...
    _proto._navigateToNewRow = function(oldEditRowIndex, change, editRowIndex) {
        ...
        var navigateToRowByKey = function(key) {
            var _a;
            (0, _deferred.when)(null === (_a = _this13._focusController) || void 0 === _a ? void 0 : _a.navigateToRow(key)).done((function() {
...
var dataControllerEditingExtenderMixin = function(Base) {
    return function(_Base) {
        ...
        _proto2._handleDataSourceChange = function(args) {
            var _this32 = this;
            var result = _Base.prototype._handleDataSourceChange.call(this, args);
...
var rowsView = function(Base) {
    return function(_Base2) {
        ...
        _proto3._getCellOptions = function(options) {
            var cellOptions = _Base2.prototype._getCellOptions.call(this, options);
            cellOptions.isEditing = this._editingController.isEditCell(cellOptions.rowIndex, cellOptions.columnIndex);
            return cellOptions
        };
        _proto3._createCell = function(options) {
            var $cell = _Base2.prototype._createCell.call(this, options);

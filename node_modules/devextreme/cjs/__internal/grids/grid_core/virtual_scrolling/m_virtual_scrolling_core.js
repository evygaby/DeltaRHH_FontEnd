...
var VirtualScrollController = function() {
    ...
    _proto.pageIndex = function() {
        var _this$_dataLoader;
        return (_this$_dataLoader = this._dataLoader).pageIndex.apply(_this$_dataLoader, arguments)
    };
    _proto.beginPageIndex = function() {
        var _this$_dataLoader2;
        return (_this$_dataLoader2 = this._dataLoader).beginPageIndex.apply(_this$_dataLoader2, arguments)
    };
    _proto.endPageIndex = function() {
        var _this$_dataLoader3;
        return (_this$_dataLoader3 = this._dataLoader).endPageIndex.apply(_this$_dataLoader3, arguments)
    };
    _proto.pageSize = function() {
        var _this$_dataLoader4;
        return (_this$_dataLoader4 = this._dataLoader).pageSize.apply(_this$_dataLoader4, arguments)
    };
    _proto.load = function() {
        var _this$_dataLoader5;
        return (_this$_dataLoader5 = this._dataLoader).load.apply(_this$_dataLoader5, arguments)
    };
    _proto.loadIfNeed = function() {
        var _this$_dataLoader6;
        return (_this$_dataLoader6 = this._dataLoader).loadIfNeed.apply(_this$_dataLoader6, arguments)
    };
    _proto.handleDataChanged = function() {
        var _this$_dataLoader7;
        return (_this$_dataLoader7 = this._dataLoader).handleDataChanged.apply(_this$_dataLoader7, arguments)
    };

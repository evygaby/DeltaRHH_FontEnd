...
var ContextMenuController = function(_modules$ViewControll) {
...
var ContextMenuView = function(_modules$View) {
    ...
    _proto2._renderCore = function() {
        ...
        this._createComponent($element, _context_menu.default, {
            onPositioning: function(actionArgs) {
                ...
                var items = _this._contextMenuController.getContextMenuItems(event);
                if (items) {

...
var DataController = function(_DataHelperMixin) {
    ...
    _proto.init = function() {
        ...
        this._dataChangedHandler = function(e) {
            _this._currentOperationTypes = _this._dataSource.operationTypes();
            _this._handleDataChanged(e);
            _this._currentOperationTypes = null
        };
        ...
        this.dataErrorOccurred.add((function(error) {
            return _this.executeAction("onDataErrorOccurred", {
                error: error
            })
        }));
    ...
    _proto.hasLoadOperation = function() {
        ...
        return Object.keys(operationTypes).some((function(type) {

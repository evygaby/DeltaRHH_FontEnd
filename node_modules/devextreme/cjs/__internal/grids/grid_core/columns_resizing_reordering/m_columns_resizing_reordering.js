...
var ColumnsResizerViewController = function(_modules$ViewControll) {
    ...
    _proto6._init = function() {
        ...
        var generatePointsByColumnsHandler = function() {
            if (!_this3._isResizing) {
                _this3.pointsByColumns(null)
            }
        };
        var generatePointsByColumnsScrollHandler = function(offset) {
            if (_this3._scrollLeft !== offset.left) {
                _this3._scrollLeft = offset.left;
                _this3.pointsByColumns(null)
            }
        };
        ...
        this._subscribeToCallback(this._columnsSeparatorView.renderCompleted, (function() {
            _this3._unsubscribeFromEvents();
            _this3._subscribeToEvents()
        }));
        this._subscribeToCallback(this._rowsView.renderCompleted, (function() {
            _this3._rowsView.scrollChanged.remove(generatePointsByColumnsScrollHandler);
            _this3._rowsView.scrollChanged.add(generatePointsByColumnsScrollHandler)
        }));
        var previousScrollbarVisibility = 0 !== this._rowsView.getScrollbarWidth();
        var previousTableHeight = 0;
        this._subscribeToCallback(this._tablePositionController.positionChanged, (function(e) {
            if (_this3._isResizing && !_this3._rowsView.isResizing) {
                var scrollbarVisibility = 0 !== _this3._rowsView.getScrollbarWidth();
                if (previousScrollbarVisibility !== scrollbarVisibility || previousTableHeight && previousTableHeight !== e.height) {
                    previousScrollbarVisibility = scrollbarVisibility;
                    previousTableHeight = e.height;
                    _this3.component.updateDimensions()
                } else {
                    _this3._rowsView.updateFreeSpaceRowHeight()
                }
            }
            previousTableHeight = e.height
        }))
...
var TablePositionViewController = function(_modules$ViewControll2) {
    ...
    function TablePositionViewController(component) {
        var _this4;
        _this4 = _modules$ViewControll2.call(this, component) || this;
        _this4.positionChanged = (0, _callbacks.default)();
        return _this4
    }
    ...
    _proto7.init = function() {
        ...
        this._rowsView.resizeCompleted.add((function() {
            if (_this5.option("allowColumnResizing")) {
                var targetPoint = _this5._columnsResizerController._targetPoint;
                _this5.update(targetPoint ? targetPoint.y : null)
            }
        }))
    };
...
var DraggingHeaderViewController = function(_modules$ViewControll3) {
    ...
    _proto8.init = function() {
        ...
        var subscribeToEvents = function() {
            if (_this6._draggingHeaderView) {
                var draggingPanels = [_this6._columnChooserView, _this6._columnHeadersView, _this6._headerPanelView];
                _this6._unsubscribeFromEvents(_this6._draggingHeaderView, draggingPanels);
                _this6._subscribeToEvents(_this6._draggingHeaderView, draggingPanels)
            }
        };
    ...
    _proto8._generatePointsByColumns = function(options) {
        ...
        var points = _m_utils.default.getPointsByColumns(options.columnElements, (function(point) {

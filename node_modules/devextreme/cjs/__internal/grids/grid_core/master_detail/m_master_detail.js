...
var columns = function(Base) {
    return function(_Base) {
        ...
        _proto._getExpandColumnsCore = function() {
            var expandColumns = _Base.prototype._getExpandColumnsCore.call(this);
...
var dataMasterDetailExtenderMixin = function(Base) {
    return function(_Base2) {
        ...
        _proto2._processDataItem = function(data, options) {
            var that = this;
            var dataItem = _Base2.prototype._processDataItem.apply(that, arguments);

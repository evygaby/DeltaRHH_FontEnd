...
var ResizingController = function(_modules$ViewControll) {
    ...
    _proto._updateDimensionsCore = function() {
        ...
        (0, _common.deferRender)((function() {
            ...
            if (!dataController.isLoaded()) {
                ...
                _this7._editorFactoryController && _this7._editorFactoryController.resize()
            }))
        }))
    };
...
var SynchronizeScrollingController = function(_modules$ViewControll2) {
...
var GridView = function(_modules$View) {

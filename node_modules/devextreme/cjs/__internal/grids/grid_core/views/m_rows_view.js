...
var RowsView = function(_ColumnsView) {
    ...
    _proto.init = function() {
        ...
        this._dataController.loadingChanged.add((function(isLoading, messageText) {
            _this.setLoading(isLoading, messageText)
        }));
        this._dataController.dataSourceChanged.add((function() {
            if (_this._scrollLeft >= 0 && !_this._dataController.isLoading()) {
                _this._handleScroll({
                    component: _this.getScrollable(),
                    forceUpdateScrollPosition: true,
                    scrollOffset: {
                        top: _this._scrollTop,
                        left: _this._scrollLeft
                    }
                })
            }
        }))
    ...
    _proto._rowPrepared = function($row, rowOptions, row) {
        ...
        if ("data" === rowOptions.rowType) {
            ...
            setWatcher({
                ...
                callBack: function() {
                    return _this2._setAriaRowIndex(rowOptions, $row)
                }
            })
        }
    ...
    _proto._afterRowPrepared = function(e) {
        ...
        var dispose = watch((function() {
            ...
            dataController.repaintRows([row.rowIndex], _this3.option("repaintChangesOnly"))
        }), {
            deep: true,
            skipImmediate: true
        });
    ...
    _proto._updateContent = function(newTableElement, change, isFixedTableRendering) {
        ...
        return this.waitAsyncTemplates().done((function() {
            var contentChanges = _this4._contentChanges;
            _this4._contentChanges = [];
            contentChanges.forEach((function(_ref3) {
                ...
                var tableElement = _this4.getTableElement(isFixedTableRendering);
                var contentElement = _this4._findContentElement(isFixedTableRendering);
                var changeType = null === change || void 0 === change ? void 0 : change.changeType;
                var executors = [];
                var highlightChanges = _this4.option("highlightChanges");
                var rowInsertedClass = _this4.addWidgetPrefix(ROW_INSERTED_ANIMATION_CLASS);
                switch (changeType) {
                    case "update":
                        (0, _iterator.each)(change.rowIndices, (function(index, rowIndex) {
                            var _a;
                            var $newRowElement = _this4._getRowElements(newTableElement).eq(index);
                            var dataChangeType = null === (_a = change.changeTypes) || void 0 === _a ? void 0 : _a[index];
                            var item = change.items && change.items[index];
                            executors.push((function() {
                                var _a;
                                var $rowElements = _this4._getRowElements(tableElement);
                                    ...
                                    case "update":
                                        if (item) {
                                            ...
                                            if ((0, _type.isDefined)(item.visible) && item.visible !== $rowElement.is(":visible")) {
                                                ...
                                                _this4._updateCells($rowElement, $newRowElement, columnIndices)
                                            } else {
                        ...
                        break;
                    default:
                        _this4.setTableElement(newTableElement, isFixedTableRendering);
                        contentElement.addClass(_this4.addWidgetPrefix(CONTENT_CLASS));
                        _this4._renderContent(contentElement, newTableElement, isFixedTableRendering)
                }
            }))
        })).fail((function() {
            _this4._contentChanges = []
            ...
            if (itemCount > 0) {
                if (!this._hasHeight) {
                    ...
                    (0, _common.deferUpdate)((function() {
                        var scrollbarWidth = _this5.getScrollbarWidth(true);
                        var elementHeightWithoutScrollbar = (0, _size.getHeight)(_this5.element()) - scrollbarWidth;
                        ...
                        var rowsHeight = _this5._getRowsHeight(contentElement.children().first());
                        var $tableElement = $table || _this5.getTableElements();
                        var borderTopWidth = Math.ceil(parseFloat($tableElement.css("borderTopWidth")));
                        var heightCorrection = _this5._getHeightCorrection();
                        ...
                        if (showFreeSpaceRow) {
                            ...
                            return _this5._updateLastRowBorder(isFreeSpaceRowVisible)
                        }))
                    }))
                }
            } else {

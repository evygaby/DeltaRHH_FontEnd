...
var ExportController = function(_dataGridCore$ViewCon) {
    ...
    _proto2._getAllItems = function(data) {
        ...
        (0, _deferred.when)(data).done((function(data) {
            _this2._dataController.loadAll(data, skipFilter).done((function(sourceItems, totalAggregates) {
    ...
    _proto2._getSummaryCells = function(summaryTotalItems, totalAggregates) {
        var _this3 = this;
        return this._dataController._calculateSummaryCells(summaryTotalItems, totalAggregates, this._columnsController.getVisibleColumns(null, true), (function(summaryItem, column) {
            return _this3._dataController._isDataColumn(column) ? column.index : -1
        }))
    };
...
var editing = function(Base) {
    return function(_Base) {
        ...
        _proto3.callbackNames = function() {
            var callbackList = _Base.prototype.callbackNames.call(this);
...
var headerPanel = function(Base) {
    return function(_Base2) {
        ...
        _proto4._getToolbarItems = function() {
            var items = _Base2.prototype._getToolbarItems.call(this);
        ...
        _proto4._getExportToolbarButton = function() {
            ...
            if (1 === items.length) {
                ...
                toolbarButtonOptions.menuItemTemplate = function(_data, _index, container) {
                    _this4._createComponent((0, _renderer.default)(container), _list_light.default, {
                        items: items
                    })
                }
            }
        ...
        _proto4._getExportToolbarItems = function() {
            ...
            formats.forEach((function(formatType) {
                ...
                items.push({
                    ...
                    icon: exportAllIcon,
                    onClick: function() {
                        _this5._exportController.exportTo(false, formatType)
                    }
                });
                if (exportOptions.allowExportSelectedData) {
                    items.push({
                        ...
                        onClick: function() {
                            _this5._exportController.exportTo(true, formatType)
                        }
                    })
                }
            }));
        ...
        _proto4.init = function() {
            ...
            this._editingController.editingButtonsUpdated.add((function() {
                var disabled = _this6._needDisableExportButton();
                _this6.setToolbarItemDisabled("exportButton", disabled)
            }))
        };

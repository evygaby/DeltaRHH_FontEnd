...
var TreeListColumnsController = function(_ColumnsController) {
    ...
    _proto._getFirstItems = function(dataSourceAdapter) {
        return _ColumnsController.prototype._getFirstItems.call(this, dataSourceAdapter).map((function(node) {
            return node.data
        }))
    };

...
_m_virtual_scrolling.virtualScrollingModule.extenders.controllers.data = function(Base) {
    return function(_virtualScrollingData) {
...
var dataSourceAdapterExtender = function(Base) {
    return function(_virtualScrollingData2) {
        ...
        _proto2.changeRowExpand = function() {
            var _this = this;
            return _virtualScrollingData2.prototype.changeRowExpand.apply(this, arguments).done((function() {

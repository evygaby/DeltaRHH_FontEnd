...
var TreeListRowsView = function(_RowsView) {
    ...
    _proto._processTemplate = function(template, options) {
        ...
        var that = this;
        var resultTemplate;
        var renderingTemplate = _RowsView.prototype._processTemplate.call(this, template);
    ...
    _proto._createRow = function(row) {
        ...
        var $rowElement = _RowsView.prototype._createRow.apply(this, arguments);
        if (node) {

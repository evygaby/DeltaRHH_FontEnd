...
class Popup extends _overlay.default {
    ...
    _renderTopToolbar() {
        ...
        if (shouldBeShown) {
            ...
            null === (_this$_$topToolbar2 = this._$topToolbar) || void 0 === _this$_$topToolbar2 || _this$_$topToolbar2.detach()
        }
    ...
    _renderBottomToolbar() {
        ...
        if (!items.length) {
            ...
            null === (_this$_$bottomToolbar = this._$bottomToolbar) || void 0 === _this$_$bottomToolbar || _this$_$bottomToolbar.detach();
            return
        }

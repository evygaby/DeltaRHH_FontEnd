...
class OverlayPositionController {
    ...
    _renderContentInitialPosition() {
        ...
        null === (_this$_$wrapper2 = this._$wrapper) || void 0 === _this$_$wrapper2 || _this$_$wrapper2.css("overflow", "hidden");
        if (!this._props._skipContentPositioning) {
            const resultPosition = _position.default.setup(this._$content, this._position);
            this._initialPosition = resultPosition
        }
        null === (_this$_$wrapper3 = this._$wrapper) || void 0 === _this$_$wrapper3 || _this$_$wrapper3.css("overflow", wrapperOverflow);
        this.detectVisualPositionChange()
    }

...
var TagBox = _select_box.default.inherit({
    ...
    _isCaretAtTheStart: function() {
        var position = (0, _utils2.default)(this._input());
    ...
    _initMultiTagPreparingAction: function() {
        ...
        this._multiTagPreparingAction = this._createActionByOption("onMultiTagPreparing", {
            beforeExecute: function(e) {
                _this2._multiTagPreparingHandler(e.args[0])
            },
    ...
    _renderEvents: function() {
        ...
        _events_engine.default.on(input, namespace, (function(e) {
            ...
            if (!_this3._isControlKey(keyName) && _this3._isEditable()) {
                _this3._clearTagFocus()
            }
        }))
    },
    ...
    _renderPreventBlurOnInputClick: function() {
        ...
        _events_engine.default.on(this._inputWrapper(), eventName, (function(e) {
            if (e.target !== _this4._input()[0] && _this4._isFocused()) {
                e.preventDefault()
            }
        }))
    },
    ...
    _renderList: function() {
        ...
        if (this.option("showSelectionControls")) {
            this._list.registerKeyHandler("tab", (function(e) {
                return _this5._popupElementTabHandler(e)
            }));
            this._list.registerKeyHandler("escape", (function(e) {
                return _this5._popupElementEscHandler(e)
            }))
        }
    },
    ...
    _listConfig: function() {
        ...
        return (0, _extend.extend)(this.callBase(), {
            ...
            onSelectAllValueChanged: function(_ref) {
                ...
                _this6._selectAllValueChangeAction({
                    value: value
                })
            },
    ...
    _renderMultiSelect: function() {
        ...
        this._renderTags().done((function() {
            _this7._popup && _this7._popup.refreshPosition();
            d.resolve()
        })).fail(d.reject);
        return d.promise()
    },
    ...
    _getFilteredItems: function(values) {
        ...
        dataController.loadFromStore({
            ...
            _this8._isDataSourceChanged = false;
            if (_this8._disposed) {
                d.reject();
                return
            }
            var _normalizeLoadResult = (0, _utils.normalizeLoadResult)(data, extra),
    ...
    _createTagsData: function(values, filteredItems) {
        ...
        filteredItems.forEach((function(filteredItem) {
            var filteredItemValue = isValueExprSpecified ? JSON.stringify(filteredItem) : _this9._valueGetter(filteredItem);
        ...
        values.forEach((function(value, index) {
            ...
            if (isValueExprSpecified && !(0, _type.isDefined)(currentItem)) {
                loadItemPromises.push(_this9._loadItem(value, cache).always((function(item) {
                    var newItem = _this9._createTagData(item, value);
                    items.splice(index, 0, newItem)
                })))
            } else {
                var newItem = _this9._createTagData(currentItem, value);
                items.splice(index, 0, newItem)
            }
        }));
        var d = new _deferred.Deferred;
    ...
    _getItemsByValues: function(values) {
        ...
        values.forEach((function(value) {
            var item = _this10._getItemFromPlain(value);
            if ((0, _type.isDefined)(item)) {
    ...
    _getFilteredGroupedItems: function(values) {
        ...
        if (!this._dataController.items().length) {
            this._filteredGroupedItemsLoadPromise = this._dataController.load().done((function() {
                selectedItems.resolve(_this11._getItemsByValues(values))
            })).fail((function() {
                selectedItems.resolve([])
            })).always((function() {
                _this11._filteredGroupedItemsLoadPromise = void 0
            }))
        } else {
    ...
    _loadTagsData: function() {
        ...
        filteredItemsPromise.done((function(filteredItems) {
            var items = _this12._createTagsData(values, filteredItems);
    ...
    _renderTags: function() {
        ...
        if (!isPlainDataUsed) {
            this._loadTagsData().done((function(items) {
                if (_this13._disposed) {
                    d.reject();
                    return
                }
                _this13._renderTagsImpl(items);
                d.resolve()
            })).fail(d.reject)
        }
        return d.promise()
        ...
        var selectedItems = plainItems.filter((function(dataItem) {
            ...
            for (var i = 0; i < values.length; i++) {
                ...
                if ((0, _type.isObject)(currentValue)) {
                    if (_this14._isValueEquals(dataItem, currentValue)) {
                        return true
                    }
                } else if (_this14._isValueEquals(_this14._valueGetter(dataItem), currentValue)) {
                    return true
                }
            }
            return false
    ...
    _renderTagsCore: function(items) {
        ...
        if (this._input().length > 0) {
            ...
            _this15._renderTagsElements(items)
        }))
    },
    _renderTagsElements: function(items) {
        ...
        items.forEach((function(item, index) {
            ...
            _this16._renderTag(item, $multiTag || _this16._input());
            return
        }));
        if (this._isFocused()) {
            this._scrollContainer("end")
    ...
    _selectionChangeHandler: function(e) {
        ...
        (0, _iterator.each)(e.removedItems || [], (function(_, removedItem) {
            _this17._removeTag(value, _this17._valueGetter(removedItem))
        }));
        (0, _iterator.each)(e.addedItems || [], (function(_, addedItem) {
            _this17._addTag(value, _this17._valueGetter(addedItem))
        }));
        this._updateWidgetHeight();
    ...
    _valueIndex: function(value, values, cache) {
        ...
        (0, _iterator.each)(values, (function(index, selectedValue) {
            if (_this18._isValueEquals(value, selectedValue)) {
                result = index;
                return false
            }
            return
    ...
    _dataSourceFilterExpr: function() {
        ...
        this._getValue().forEach((function(value) {
            return filter.push(["!", [_this19._valueGetterExpr(), value]])
        }));
        return filter
    },
    _dataSourceFilterFunction: function(itemData) {
        ...
        (0, _iterator.each)(this._getValue(), (function(index, value) {
            if (_this20._isValueEquals(value, itemValue)) {
                result = false;
                return false
            }
            return
    ...
    _getListValues: function() {
        ...
        return this._getPlainItems(this._list.option("selectedItems")).map((function(item) {
            return _this21._valueGetter(item)
        }))
    },
    ...
    _getSelectedItemsDifference: function(newItems, previousItems) {
        ...
        var previousItemsValuesMap = previousItems.reduce((function(map, item) {
            var value = _this22._valueGetter(item);
            map[value] = item;
            return map
        }), {});
        var addedItems = [];

...
var SelectBox = _ui.default.inherit({
    ...
    _setNextValue: function(e) {
        ...
        dataSourceIsLoaded.done((function() {
            var selectedIndex = _this3._getSelectedIndex();
            var hasPages = _this3._dataController.pageSize();
            var isLastPage = _this3._dataController.isLastPage();
            var isLastItem = selectedIndex === _this3._items().length - 1;
            _this3._saveValueChangeEvent(e);
            var step = "downArrow" === (0, _index.normalizeKeyName)(e) ? 1 : -1;
            if (hasPages && !isLastPage && isLastItem && step > 0) {
                if (!_this3._popup) {
                    _this3._createPopup()
                }
                if (!_this3._dataController.isLoading()) {
                    _this3._list._loadNextPage().done(_this3._setNextItem.bind(_this3, step))
                }
            } else {
                _this3._setNextItem(step)
            }
        }))
    },
    ...
    _selectionChangeHandler: function(e) {
        ...
        (0, _iterator.each)(e.addedItems || [], (function(_, addedItem) {
            _this4._setValue(_this4._valueGetter(addedItem))
        }))
    },
    ...
    _restoreInputText: function(saveEditingValue) {
        ...
        this._loadItemDeferred && this._loadItemDeferred.always((function() {
            var _this5$option = _this5.option(),
                acceptCustomValue = _this5$option.acceptCustomValue,
                text = _this5$option.text,
                initialSelectedItem = _this5$option.selectedItem;
            if (acceptCustomValue) {
                if (!saveEditingValue && !_this5._isValueChanging) {
                    _this5._updateField(null !== initialSelectedItem && void 0 !== initialSelectedItem ? initialSelectedItem : _this5._createCustomItem(text));
                    _this5._clearFilter()
                }
                return
            }
            if (_this5.option("searchEnabled")) {
                if (!_this5._searchValue() && _this5.option("allowClearing")) {
                    _this5._clearTextValue();
                    return
                }
            }
            if (_this5._isValueEqualInputText()) {
                return
            }
            _this5._renderInputValue().always((function(selectedItem) {
                var newSelectedItem = (0, _common.ensureDefined)(selectedItem, initialSelectedItem);
                _this5._setSelectedItem(newSelectedItem);
                _this5._updateField(newSelectedItem);
                _this5._clearFilter()
            }))
        }))
    },

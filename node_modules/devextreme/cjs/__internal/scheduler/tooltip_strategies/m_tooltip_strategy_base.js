...
var TooltipStrategyBase = function() {
    ...
    _proto._createFunctionTemplate = function(template, appointmentData, targetedAppointmentData, index) {
        ...
        return new _function_template.FunctionTemplate((function(options) {
            var _createPromise = (0, _promise.createPromise)(),
                promise = _createPromise.promise,
                resolve = _createPromise.resolve;
            _this3.asyncTemplatePromises.add(promise);
            return template.render({
                ...
                index: index,
                onRendered: function() {
                    _this3.asyncTemplatePromises.delete(promise);
                    resolve()
                }
            })
        }))
    ...
    _proto._createDeleteButton = function(appointment, targetedAppointment) {
        ...
        this._options.createComponent($deleteButton, _button.default, {
            ...
            onClick: function(e) {
                ...
                _this4._options.checkAndDeleteAppointment(appointment, targetedAppointment)
            }
        });
        return $container
    };

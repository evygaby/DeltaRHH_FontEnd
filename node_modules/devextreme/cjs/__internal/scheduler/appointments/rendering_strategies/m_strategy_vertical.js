...
var VerticalRenderingStrategy = function(_BaseAppointmentsStra) {
    ...
    _proto._getAppointmentParts = function(appointmentGeometry, appointmentSettings) {
        ...
        var columnIndex = appointmentSettings.columnIndex;
    ...
    _proto.calculateAppointmentWidth = function(appointment, position) {
        ...
        var skippedHours = (0, _getSkippedHoursInRange.default)(position.info.appointment.startDate, position.info.appointment.endDate, appointment.allDay, this.viewDataProvider);

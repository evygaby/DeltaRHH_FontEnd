...
var VerticalGroupedStrategy = function() {
    ...
    _proto.getWorkSpaceMinWidth = function() {
        ...
        var workSpaceElementWidth = (0, _position.getBoundingRect)(this._workSpace.$element().get(0)).width;
        var workspaceContainerWidth = workSpaceElementWidth - this._workSpace.getTimePanelWidth() - this._workSpace.getGroupTableWidth() - 2 * _const.WORK_SPACE_BORDER_PX;

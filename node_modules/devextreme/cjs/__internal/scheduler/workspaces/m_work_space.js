...
var SchedulerWorkSpace = function(_WidgetObserver) {
    ...
    _proto.getCellIndexByCoordinates = function(coordinates, allDay) {
        var _a, _b, _c;
        var _this$virtualScrollin = this.virtualScrollingDispatcher,
            horizontalScrollingState = _this$virtualScrollin.horizontalScrollingState,
            verticalScrollingState = _this$virtualScrollin.verticalScrollingState;

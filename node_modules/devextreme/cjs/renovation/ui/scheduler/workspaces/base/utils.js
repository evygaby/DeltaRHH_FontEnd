 ...
 */
"use strict";
exports.splitNumber = exports.isCellAllDay = exports.getTotalRowCount = exports.getTotalCellCount = exports.getSelectedCells = exports.getRowCountWithAllDayRow = exports.getHiddenInterval = exports.getDateTableWidth = exports.getDateForHeaderText = exports.getCellIndices = exports.createVirtualScrollingOptions = exports.createCellElementMetaData = exports.compareCellsByDateAndIndex = exports.DATE_TABLE_MIN_CELL_WIDTH = void 0;
...
var splitNumber = function(value, splitValue) {
    return Array.from({
        length: Math.ceil(value / splitValue)
    }, (function(_, index) {
        return Math.min(value - splitValue * index, splitValue)
    }))
};

...
var viewFunction = function(_ref) {
    ...
    return (0, _inferno.createVNode)(1, "tr", className, [hasLeftVirtualCell && null != leftVirtualCellCount && (0, _utils.splitNumber)(leftVirtualCellCount, MAX_COL_SPAN).map((function(colSpan, index) {
        return (0, _inferno.createComponentVNode)(2, _virtual_cell.VirtualCell, {
            width: leftVirtualCellWidth * (colSpan / leftVirtualCellCount),
            colSpan: colSpan,
            isHeaderCell: isHeaderRow
        }, "left-virtual-cell-".concat(index))
    })), children, hasRightVirtualCell && null != rightVirtualCellCount && (0, _utils.splitNumber)(rightVirtualCellCount, MAX_COL_SPAN).map((function(colSpan, index) {
        return (0, _inferno.createComponentVNode)(2, _virtual_cell.VirtualCell, {
            width: rightVirtualCellWidth * (colSpan / rightVirtualCellCount),
            colSpan: colSpan,
            isHeaderCell: isHeaderRow
        }, "right-virtual-cell-".concat(index))
    }))], 0, {

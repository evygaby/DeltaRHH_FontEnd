...
class VerticalRenderingStrategy extends BaseAppointmentsStrategy {
    ...
    calculateAppointmentWidth(appointment, position) {
        ...
        var skippedHours = getSkippedHoursInRange(position.info.appointment.startDate, position.info.appointment.endDate, appointment.allDay, this.viewDataProvider);

...
class Drawer extends Widget {
    ...
    _togglePanelContentHiddenClass() {
        const callback = () => {
            ...
            null === (_this$_$panelContentW = this._$panelContentWrapper) || void 0 === _this$_$panelContentW || _this$_$panelContentW.toggleClass("dx-drawer-panel-content-hidden", shouldBeSet)
        };
    ...
    setZIndex(zIndex) {
        ...
        null === (_this$_$panelContentW2 = this._$panelContentWrapper) || void 0 === _this$_$panelContentW2 || _this$_$panelContentW2.css("zIndex", zIndex)
    }
    resizeContent() {

...
class ContextMenu extends MenuBase {
    ...
    _hideAllShownSubmenus() {
        var _this$_overlay5;
        const shownSubmenus = extend([], this._shownSubmenus);
        const $expandedItems = (null === (_this$_overlay5 = this._overlay) || void 0 === _this$_overlay5 ? void 0 : _this$_overlay5.$content().find(".dx-menu-item-expanded")) ?? $();
        $expandedItems.removeClass("dx-menu-item-expanded");
    ...
    _show(event) {
        ...
        if (position) {
            ...
            const $subMenu = $(null === (_this$_overlay6 = this._overlay) || void 0 === _this$_overlay6 ? void 0 : _this$_overlay6.content()).children(".dx-submenu");
